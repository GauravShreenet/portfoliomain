    ...
    return (
        <>
            <div className="col-md-6 mt-5 mb-5">
                <div className="boxShad ms-5 rounded-4" style={{ padding: '2rem' }}>
                    ...
                    <div className="col rounded-4 overflow-hidden">
                        <a href={linkPage} target="_blank">
                            <img
                                ...
                                style={{ height: '25vw', transition: 'transform 0.5s ease', cursor: 'pointer' }}
                    ...
                    <div className="col d-flex flex-column justify-content-center mt-5">
                        ...
                        <div className="d-flex justify-content-between fs-1 mt-3">
                            <a href={linkGit} target="_blank" className="me-4">
